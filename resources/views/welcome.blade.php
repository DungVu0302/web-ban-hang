                    ...
                    <div class="col-sm-5">
                        <form method="post" action="{{URL::to('/tim-kiem')}}">
                            ...
                            <div class="search_box pull-right">
                                ...
                                <input type="submit" style="margin-top:0px;color: #100f0f;" name="search" class="btn btn-primary btn-sm" value="Tìm kiếm">
                            </div>
                        </form>
                        ...
                        <div class="brands_products">
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="{{URL::to('/thuong-hieu-san-pham/'.$br->branch_id)}}"> <span class="pull-right">(50)</span>{{$br->branch_name}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
